...
import com.yq.srdb.backend.vm.VersionManagerImpl;
...
public class Launcher {
    ...
    public static final String DB_PREFIX = "server/db/";
    ...
    public static void main(String[] args) throws ParseException {
        ...
        if(cmd.hasOption("open")) {
            openDB(DB_PREFIX+cmd.getOptionValue("open"), parseMem(cmd.getOptionValue("mem")));
            return;
        }
        if(cmd.hasOption("create")) {
            createDB(DB_PREFIX+cmd.getOptionValue("create"));
            return;
        }
