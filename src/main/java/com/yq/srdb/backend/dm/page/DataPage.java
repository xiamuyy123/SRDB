...
public class DataPage {
    ...
    public static final int MAX_FREE_SPACE = PageCache.PAGE_SIZE - OFFSET_DATA; //最大空闲空间
    ...
    //插入raw到page中
    public static int insert(Page page,byte[] raw){
        page.setDirty(true);
    ...
    public static void setFSO(byte[] raw,short offset){
        System.arraycopy(Parser.short2Byte(offset),0,raw,OFFSET_FREE,OFFSET_DATA);
    }
